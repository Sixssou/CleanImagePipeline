...
class GitAutomator:
    ...
    def get_git_changes(self):
        ...
        try:
            ...
            logger.error(f"Erreur lors de la récupération des modifications Git: {e}")
            return None
    ...
    def generate_commit_message(self, changes):
        ...
        try:
            ...
            logger.error(f"Erreur lors de la génération du message: {e}")
    ...
    def execute_git_commands(self):
        ...
        try:
            ...
            if not changes:
                logger.info("Aucune modification à commiter")
                return
            ...
            logger.info(f"✅ Push réussi avec le message: {commit_message}")
...
if __name__ == "__main__":
    ...
    if not api_key:
        logger.error("❌ OPENAI_API_GIT_AUTOMATOR_KEY non définie dans les variables d'environnement")
        sys.exit(1)
